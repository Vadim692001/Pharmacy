...
export class Supplier extends Component{
    ...
    render(){
        const {sups,supid,supname,supcity,supcountry}=this.state;
    ...
    onClick={()=>this.setState({editModalShow:true,
        supid:su.IdSupplier,supname:su.NameSupplier,supcity:su.CitySupplier,supcountry:su.CountrySupplier})}>
            Edit
        </Button>
